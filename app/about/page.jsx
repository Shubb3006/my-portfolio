  ...
  return (
    <div className={styles.wrapper}>
      <main className={styles.container}>
        <h1>About Me</h1>
        <p>
          Hello! I'm a passionate <strong>Frontend Developer</strong>{" "}
          specializing in building modern, responsive, and user-friendly web
          applications. I love turning creative designs into pixel-perfect
          websites that offer great user experiences.
        </p>
        <p>
          My expertise includes <strong>React</strong>, <strong>Next.js</strong>,{" "}
          <strong>JavaScript</strong>, <strong>Tailwind CSS</strong>, and{" "}
          <strong>TypeScript</strong>. I’m always eager to learn new
          technologies and improve my skills to deliver high-quality projects.
        </p>
        <p>
          When I’m not coding, I enjoy exploring UI/UX trends, experimenting
          with new design tools, and contributing to open-source projects. Feel
          free to connect with me to discuss web development, collaboration, or
          exciting projects!
        </p>
